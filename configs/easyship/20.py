# change stepsize and N_iters, num_voxels, net width

_base_ = '../default.py'
basedir = './logs/nerf_synthetic'

data = dict(
    datadir='./filter_data/nerf_synthetic/Easyship',
    # npy_datadir='./filter_npy_data/nerf_synthetic/Easyship/',
...
ratio = 3
expname = f'Easyship20_{data["near"]}_{data["far"]}'
